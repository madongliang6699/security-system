...
public class CodeGenerator {
    ...
    private final static String author = "security";
     ...
     * 模块包名
     */
    private final static String module = "com.security";
    ...
    public static void main(String[] args) {
        ...
        String projectPath = System.getProperty("user.dir") + "/security-generator";
