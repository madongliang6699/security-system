 ...
 */
public class CybstarWebSocketHandler extends TextWebSocketHandler {
     ...
     * 存放每个客户端连接对象
     */
    private static final ConcurrentHashMap<Integer, WebSocketSession> sessionPools = new ConcurrentHashMap<>();
