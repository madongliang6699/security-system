 ...
 * @author A
 * @version v 0.1
 * @File HseHazardousWasteGenerationVO.java
 * @Desc 固废管理-危废产生
 * @DateTime 2023-07-12 15:08:19
 * @Encoding UTF-8
 * @Description Copyright (c) 2004-2023 All Rights Reserved.
 */
public class HseHazardousWasteGenerationVO extends CybVoBase<HseHazardousWasteGeneration, HseHazardousWasteGenerationDTO, HseHazardousWasteGenerationVO> implements Serializable {
     ...
     * 转换成固废管理-危废产生DTO对象
     *
     * @return 固废管理-危废产生DTO对象
     */
    @Override
    protected HseHazardousWasteGenerationDTO convertToDto() {
        HseHazardousWasteGenerationDTO hseHazardousWasteGenerationDTO = new HseHazardousWasteGenerationDTO();
        BeanUtils.copyProperties(this, hseHazardousWasteGenerationDTO);
