 ...
 * @author A
 * @version v 0.1
 * @File HseHazardousWasteOutsourcingDTO.java
 * @Desc 固废处理-危废委外利用处置
 * @DateTime 2023-07-18 11:04:20
 * @Encoding UTF-8
 * @Description Copyright (c) 2004-2023 All Rights Reserved.
 */
public class HseHazardousWasteOutsourcingDTO extends CybDtoBase<HseHazardousWasteOutsourcing, HseHazardousWasteOutsourcingDTO, HseHazardousWasteOutsourcingVO> implements Serializable {
