 ...
 * @author A
 * @version v 0.1
 * @File HseHazardousWasteOutboundVO.java
 * @Desc 固废管理-危废出库
 * @DateTime 2023-07-17 15:08:57
 * @Encoding UTF-8
 * @Description Copyright (c) 2004-2023 All Rights Reserved.
 */
public class HseHazardousWasteOutboundVO extends CybVoBase<HseHazardousWasteOutbound, HseHazardousWasteOutboundDTO, HseHazardousWasteOutboundVO> implements Serializable {
