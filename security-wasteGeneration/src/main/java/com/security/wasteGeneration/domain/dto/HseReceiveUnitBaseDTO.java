 ...
 * @author A
 * @version v 0.1
 * @File HseReceiveUnitBaseDTO.java
 * @Desc 固废管理-接收单位基础信息管理
 * @DateTime 2023-07-10 17:42:31
 * @Encoding UTF-8
 * @Description Copyright (c) 2004-2023 All Rights Reserved.
 */
public class HseReceiveUnitBaseDTO extends CybDtoBase<HseReceiveUnitBase, HseReceiveUnitBaseDTO, HseReceiveUnitBaseVO> implements Serializable {
     ...
     * @param name 单位名称
     */
    public HseReceiveUnitBaseDTO name(String name) {
        this.name = name;
        return this;
    }
     ...
     * @param address 单位地址
     */
    public HseReceiveUnitBaseDTO address(String address) {
        this.address = address;
        return this;
    }
     ...
     * @param administrativeDivisionId 行政区划id
     */
    public HseReceiveUnitBaseDTO administrativeDivisionId(String administrativeDivisionId) {
        this.administrativeDivisionId = administrativeDivisionId;
        return this;
    }
     ...
     * @param administrativeDivisionName 行政区划name
     */
    public HseReceiveUnitBaseDTO administrativeDivisionName(String administrativeDivisionName) {
        this.administrativeDivisionName = administrativeDivisionName;
        return this;
    }
     ...
     * @param linkman 联系人
     */
    public HseReceiveUnitBaseDTO linkman(String linkman) {
        this.linkman = linkman;
        return this;
    }
     ...
     * @param contactNumber 联系电话
     */
    public HseReceiveUnitBaseDTO contactNumber(String contactNumber) {
        this.contactNumber = contactNumber;
        return this;
    }
     ...
     * @param licenseNumber 危险废物经营许可证编号
     */
    public HseReceiveUnitBaseDTO licenseNumber(String licenseNumber) {
        this.licenseNumber = licenseNumber;
        return this;
    }
     ...
     * @param fileId 附件
     */
    public HseReceiveUnitBaseDTO fileId(String fileId) {
        this.fileId = fileId;
        return this;
    }
     ...
     * @param tenantId 租户id
     */
    public HseReceiveUnitBaseDTO tenantId(String tenantId) {
        this.tenantId = tenantId;
        return this;
    }
     ...
     * @param tenantName 租户名称
     */
    public HseReceiveUnitBaseDTO tenantName(String tenantName) {
        this.tenantName = tenantName;
        return this;
    }
    
    
    public HseReceiveUnitBaseDTO appId(Integer appId) {
    ...
    /**
     * 转换成固废管理-接收单位基础信息管理Entity对象
     *
     * @return 固废管理-接收单位基础信息管理Entity对象
     */
    @Override
    protected HseReceiveUnitBase convertToEntity() {
        HseReceiveUnitBase hseReceiveUnitBase = new HseReceiveUnitBase();
        BeanUtils.copyProperties(this, hseReceiveUnitBase);
