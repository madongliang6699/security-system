 ...
 */
public class HseHazardousWasteWarehousingDTO extends CybDtoBase<HseHazardousWasteWarehousing, HseHazardousWasteWarehousingDTO, HseHazardousWasteWarehousingVO> implements Serializable {
    ...
    public HseHazardousWasteWarehousingDTO appId(Integer appId) {
     ...
     * 转换成固废管理-危废入库VO对象
     *
     * @return 固废管理-危废入库VO对象
     */
    @Override
    protected HseHazardousWasteWarehousingVO convertToVo() {
        HseHazardousWasteWarehousingVO hseHazardousWasteWarehousingVO = new HseHazardousWasteWarehousingVO();
        BeanUtils.copyProperties(this, hseHazardousWasteWarehousingVO);
