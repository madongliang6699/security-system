 ...
 * @author A
 * @version v 0.1
 * @File HseHazardousWasteOutboundDTO.java
 * @Desc 固废管理-危废出库
 * @DateTime 2023-07-17 15:08:57
 * @Encoding UTF-8
 * @Description Copyright (c) 2004-2023 All Rights Reserved.
 */
public class HseHazardousWasteOutboundDTO extends CybDtoBase<HseHazardousWasteOutbound, HseHazardousWasteOutboundDTO, HseHazardousWasteOutboundVO> implements Serializable {
     ...
     * @param wasteBaseId 关联的废物id
     */
    public HseHazardousWasteOutboundDTO wasteBaseId(String wasteBaseId) {
        this.wasteBaseId = wasteBaseId;
        return this;
    }
     ...
     * @param warehousingIds 关联的入库ids
     */
    public HseHazardousWasteOutboundDTO warehousingIds(String warehousingIds) {
        this.warehousingIds = warehousingIds;
        return this;
    }
     ...
     * @param outboundCode 出库批次编码
     */
    public HseHazardousWasteOutboundDTO outboundCode(String outboundCode) {
        this.outboundCode = outboundCode;
        return this;
    }
     ...
     * @param outboundTime 出库时间
     */
    public HseHazardousWasteOutboundDTO outboundTime(Date outboundTime) {
        this.outboundTime = outboundTime;
        return this;
    }
     ...
     * @param outboundQuantity 出库量
     */
    public HseHazardousWasteOutboundDTO outboundQuantity(BigDecimal outboundQuantity) {
        this.outboundQuantity = outboundQuantity;
        return this;
    }
     ...
     * @param transportOrgId 运送部门id
     */
    public HseHazardousWasteOutboundDTO transportOrgId(String transportOrgId) {
        this.transportOrgId = transportOrgId;
        return this;
    }
     ...
     * @param transportOrgName 运送部门name
     */
    public HseHazardousWasteOutboundDTO transportOrgName(String transportOrgName) {
        this.transportOrgName = transportOrgName;
        return this;
    }
     ...
     * @param transportPersonId 运送部门经办人id
     */
    public HseHazardousWasteOutboundDTO transportPersonId(String transportPersonId) {
        this.transportPersonId = transportPersonId;
        return this;
    }
     ...
     * @param transportPersonName 运送部门经办人name
     */
    public HseHazardousWasteOutboundDTO transportPersonName(String transportPersonName) {
        this.transportPersonName = transportPersonName;
        return this;
    }
     ...
     * @param outboundOrgId 出库部门id
     */
    public HseHazardousWasteOutboundDTO outboundOrgId(String outboundOrgId) {
        this.outboundOrgId = outboundOrgId;
        return this;
    }
     ...
     * @param outboundOrgName 出库部门name
     */
    public HseHazardousWasteOutboundDTO outboundOrgName(String outboundOrgName) {
        this.outboundOrgName = outboundOrgName;
        return this;
    }
     ...
     * @param outboundPersonId 出库部门经办人id
     */
    public HseHazardousWasteOutboundDTO outboundPersonId(String outboundPersonId) {
        this.outboundPersonId = outboundPersonId;
        return this;
    }
     ...
     * @param outboundPersonName 出库部门经办人name
     */
    public HseHazardousWasteOutboundDTO outboundPersonName(String outboundPersonName) {
        this.outboundPersonName = outboundPersonName;
        return this;
    }
     ...
     * @param storagePositionCode 贮存设施字典编码
     */
    public HseHazardousWasteOutboundDTO storagePositionCode(String storagePositionCode) {
        this.storagePositionCode = storagePositionCode;
        return this;
    }
     ...
     * @param storagePositionName 贮存设施字典名称
     */
    public HseHazardousWasteOutboundDTO storagePositionName(String storagePositionName) {
        this.storagePositionName = storagePositionName;
        return this;
    }
     ...
     * @param storagePositionType 贮存设施字典类型
     */
    public HseHazardousWasteOutboundDTO storagePositionType(String storagePositionType) {
        this.storagePositionType = storagePositionType;
        return this;
    }
     ...
     * @param containerCode 容器/包装编码和类型code
     */
    public HseHazardousWasteOutboundDTO containerCode(String containerCode) {
        this.containerCode = containerCode;
        return this;
    }
     ...
     * @param containerName 容器/包装编码和类型name
     */
    public HseHazardousWasteOutboundDTO containerName(String containerName) {
        this.containerName = containerName;
        return this;
    }
     ...
     * @param status 状态(0待处置;1已处置)
     */
    public HseHazardousWasteOutboundDTO status(String status) {
        this.status = status;
        return this;
    }
     ...
     * @param measurementUnitCode 计量单位code
     */
    public HseHazardousWasteOutboundDTO measurementUnitCode(String measurementUnitCode) {
        this.measurementUnitCode = measurementUnitCode;
        return this;
    }
     ...
     * @param measurementUnitName 计量单位name
     */
    public HseHazardousWasteOutboundDTO measurementUnitName(String measurementUnitName) {
        this.measurementUnitName = measurementUnitName;
        return this;
    }
     ...
     * @param containerNumber 容器/包装个数
     */
    public HseHazardousWasteOutboundDTO containerNumber(Integer containerNumber) {
        this.containerNumber = containerNumber;
        return this;
    }
     ...
     * @param warehousingCodes 入库批次编码
     */
    public HseHazardousWasteOutboundDTO warehousingCodes(String warehousingCodes) {
        this.warehousingCodes = warehousingCodes;
        return this;
    }
     ...
     * @param destinationOrgId 去向单位id
     */
    public HseHazardousWasteOutboundDTO destinationOrgId(String destinationOrgId) {
        this.destinationOrgId = destinationOrgId;
        return this;
    }
     ...
     * @param destinationOrgName 去向单位name
     */
    public HseHazardousWasteOutboundDTO destinationOrgName(String destinationOrgName) {
        this.destinationOrgName = destinationOrgName;
        return this;
    }
     ...
     * @param fileId 附件
     */
    public HseHazardousWasteOutboundDTO fileId(String fileId) {
        this.fileId = fileId;
        return this;
    }
     ...
     * @param yearTag 编号年份标记
     */
    public HseHazardousWasteOutboundDTO yearTag(String yearTag) {
        this.yearTag = yearTag;
        return this;
    }
     ...
     * @param serialNumber 每个标记的最大序号
     */
    public HseHazardousWasteOutboundDTO serialNumber(Integer serialNumber) {
        this.serialNumber = serialNumber;
        return this;
    }
     ...
     * @param tenantId 租户id
     */
    public HseHazardousWasteOutboundDTO tenantId(String tenantId) {
        this.tenantId = tenantId;
        return this;
    }
     ...
     * @param tenantName 租户名称
     */
    public HseHazardousWasteOutboundDTO tenantName(String tenantName) {
        this.tenantName = tenantName;
        return this;
    }
    
    
    public HseHazardousWasteOutboundDTO appId(Integer appId) {
    ...
    /**
     * 转换成固废管理-危废出库Entity对象
     *
     * @return 固废管理-危废出库Entity对象
     */
    @Override
    protected HseHazardousWasteOutbound convertToEntity() {
        HseHazardousWasteOutbound hseHazardousWasteOutbound = new HseHazardousWasteOutbound();
        BeanUtils.copyProperties(this, hseHazardousWasteOutbound);
