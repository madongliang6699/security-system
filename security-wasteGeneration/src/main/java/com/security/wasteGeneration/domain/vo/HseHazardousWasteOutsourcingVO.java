 ...
 * @author A
 * @version v 0.1
 * @File HseHazardousWasteOutsourcingVO.java
 * @Desc 固废处理-危废委外利用处置
 * @DateTime 2023-07-18 11:04:20
 * @Encoding UTF-8
 * @Description Copyright (c) 2004-2023 All Rights Reserved.
 */
public class HseHazardousWasteOutsourcingVO extends CybVoBase<HseHazardousWasteOutsourcing, HseHazardousWasteOutsourcingDTO, HseHazardousWasteOutsourcingVO> implements Serializable {
    ...
    public HseHazardousWasteBaseVO getHseHazardousWasteBaseVO() {
        return hseHazardousWasteBaseVO;
    }

    public void setHseHazardousWasteBaseVO(HseHazardousWasteBaseVO hseHazardousWasteBaseVO) {
        this.hseHazardousWasteBaseVO = hseHazardousWasteBaseVO;
    }
    ...
    /**
     * 转换成固废处理-危废委外利用处置Entity对象
     *
     * @return 固废处理-危废委外利用处置Entity对象
     */
    @Override
    protected HseHazardousWasteOutsourcing convertToEntity(){
        HseHazardousWasteOutsourcing hseHazardousWasteOutsourcing = new HseHazardousWasteOutsourcing();
        hseHazardousWasteOutsourcing.setTenantId(this.getTenantId());
        hseHazardousWasteOutsourcing.setTenantName(this.getTenantName());
        hseHazardousWasteOutsourcing.setOutsourcingTypeCode(this.getOutsourcingTypeCode());
        hseHazardousWasteOutsourcing.setOutsourcingTypeName(this.getOutsourcingTypeName());
        hseHazardousWasteOutsourcing.setWasteBaseId(this.getWasteBaseId());
        hseHazardousWasteOutsourcing.setSource(this.getSource());
        hseHazardousWasteOutsourcing.setDeliveryTime(this.getDeliveryTime());
        hseHazardousWasteOutsourcing.setDisposalCode(this.getDisposalCode());
        hseHazardousWasteOutsourcing.setDisposalVolume(this.getDisposalVolume());
        hseHazardousWasteOutsourcing.setPackagingAndTypeCode(this.getPackagingAndTypeCode());
        hseHazardousWasteOutsourcing.setPackagingAndTypeName(this.getPackagingAndTypeName());
        hseHazardousWasteOutsourcing.setNumberOfPackages(this.getNumberOfPackages());
        hseHazardousWasteOutsourcing.setDisposalMethodCode(this.getDisposalMethodCode());
        hseHazardousWasteOutsourcing.setDisposalMethodName(this.getDisposalMethodName());
        hseHazardousWasteOutsourcing.setReceivingUnitTypeId(this.getReceivingUnitTypeId());
        hseHazardousWasteOutsourcing.setReceivingUnitTypeName(this.getReceivingUnitTypeName());
        hseHazardousWasteOutsourcing.setUnitId(this.getUnitId());
        hseHazardousWasteOutsourcing.setUnitName(this.getUnitName());
        hseHazardousWasteOutsourcing.setExportDocumentNumber(this.getExportDocumentNumber());
        hseHazardousWasteOutsourcing.setLicenseCode(this.getLicenseCode());
        hseHazardousWasteOutsourcing.setGenerationOutboundIds(this.getGenerationOutboundIds());
        hseHazardousWasteOutsourcing.setGenerationOutboundBatchEncoding(this.getGenerationOutboundBatchEncoding());
        hseHazardousWasteOutsourcing.setYearTag(this.getYearTag());
        hseHazardousWasteOutsourcing.setSerialNumber(this.getSerialNumber());
        return hseHazardousWasteOutsourcing;
    }
