...
/**
 * 固废管理-危废基础信息管理数据库访问控制类
 *
 * @author A
 * @version v 0.1
 * @File HseHazardousWasteBase.java
 * @DateTime 2023-07-10 15:19:25
 * @Encoding UTF-8
 * @Description Copyright (c) 2004-2023 All Rights Reserved.
 */
@Repository
public interface HseHazardousWasteBaseMapper {
     ...
     * @return 影响行数
     */
    Integer insert(HseHazardousWasteBase entity);
     ...
     * @return 影响行数
     */
    Integer updateById(HseHazardousWasteBase entity);
     ...
     * @return T
     */
    HseHazardousWasteBase selectById(Long sid);
     ...
     *
     * @param idList 主键ID列表
     * @return 固废管理-危废基础信息管理对象集合
     */
    List<HseHazardousWasteBase> selectBatchIds(List idList);
     ...
     * @return 固废管理-危废基础信息管理对象集合
     */
    List<HseHazardousWasteBase> selectByEntity(HseHazardousWasteBase entity);
     ...
     * @return 固废管理-危废基础信息管理对象集合
     */
    List<HseHazardousWasteBaseVO> selectByKeyWord(HseHazardousWasteBaseDTO dto);
