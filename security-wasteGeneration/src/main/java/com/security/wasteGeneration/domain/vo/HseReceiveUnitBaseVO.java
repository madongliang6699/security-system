 ...
 * @author A
 * @version v 0.1
 * @File HseReceiveUnitBaseVO.java
 * @Desc 固废管理-接收单位基础信息管理
 * @DateTime 2023-07-10 17:43:48
 * @Encoding UTF-8
 * @Description Copyright (c) 2004-2023 All Rights Reserved.
 */
public class HseReceiveUnitBaseVO extends CybVoBase<HseReceiveUnitBase, HseReceiveUnitBaseDTO, HseReceiveUnitBaseVO> implements Serializable {
