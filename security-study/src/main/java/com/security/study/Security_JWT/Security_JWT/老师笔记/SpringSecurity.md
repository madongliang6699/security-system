...
![image-20220110112541559](SpringSecurity截图/image-20220110112541559.png)
...
![image-20220110104531129](SpringSecurity截图/image-20220110104531129.png)
...
![image-20220110103518334](SpringSecurity截图/image-20220110103518334.png)

#### Authentication

认证以及认证成功的信息主要是由 Authentication 的实现类进行保存的，其接口定义为：

![image-20220110104815645](SpringSecurity截图/image-20220110104815645.png)
...
![image-20220110110946267](SpringSecurity截图/image-20220110110946267.png)

#### AccessDecisionVoter

> AccessDecisionVoter (访问决定投票器)，投票器会检查用户是否具备应有的角色，进而投出赞成、反对或者弃权票。

![image-20220110111011018](SpringSecurity截图/image-20220110111011018.png)
...
![image-20220110111037603](SpringSecurity截图/image-20220110111037603.png)
...
![image-20220110113408799](SpringSecurity截图/image-20220110113408799.png)
...
![image-20220110113534290](SpringSecurity截图/image-20220110113534290.png)
...
![image-20220110113757100](SpringSecurity截图/image-20220110113757100.png)
...
![image-20220110114044889](SpringSecurity截图/image-20220110114044889.png)

![image-20220110114109713](SpringSecurity截图/image-20220110114109713.png)
...
![image-20220110114258671](SpringSecurity截图/image-20220110114258671.png)

![image-20220110114227714](SpringSecurity截图/image-20220110114227714.png)
...
![image-20220110120349053](SpringSecurity截图/image-20220110120349053.png)

![image-20220110115946010](SpringSecurity截图/image-20220110115946010.png)
...
![image-20220111211538604](SpringSecurity截图/image-20220111211538604.png)

![image-20220111211436764](SpringSecurity截图/image-20220111211436764.png)
...
![image-20220112095052138](SpringSecurity截图/image-20220112095052138.png)
...
![image-20220112095638356](SpringSecurity截图/image-20220112095638356.png)

如果要对 Spring Security 进行自定义配置，就要自定义这个类实例，通过覆盖类中方法达到修改默认配置的目的。

### 流程分析

![image-20220111100643506](SpringSecurity截图/image-20220111100643506.png)
...
![image-20220112141503914](SpringSecurity截图/image-20220112141503914.png)

2. 处理登录为 FormLoginConfigurer 类中 调用 UsernamePasswordAuthenticationFilter这个类实例

![image-20220111104043636](SpringSecurity截图/image-20220111104043636.png)

3. 查看类中 UsernamePasswordAuthenticationFilter#attempAuthentication 方法得知实际调用 AuthenticationManager 中 authenticate 方法

![image-20220111103955782](SpringSecurity截图/image-20220111103955782.png)

4. 调用 ProviderManager 类中方法 authenticate

![image-20220111104357476](SpringSecurity截图/image-20220111104357476.png)

5. 调用了 ProviderManager 实现类中 AbstractUserDetailsAuthenticationProvider类中方法

![image-20220111104627002](SpringSecurity截图/image-20220111104627002.png)

6. 最终调用实现类 DaoAuthenticationProvider 类中方法比较

![image-20220111105029814](SpringSecurity截图/image-20220111105029814.png)

![image-20220111103729166](SpringSecurity截图/image-20220111103729166.png)
...
![image-20220111110043474](SpringSecurity截图/image-20220111110043474.png)
...
![image-20220111111244739](SpringSecurity截图/image-20220111111244739.png)
...
![image-20220112150612023](SpringSecurity截图/image-20220112150612023.png)

- **WebSecurityConfigurerAdapter** 扩展 Spring Security 所有默认配置

  ![image-20220112150820284](SpringSecurity截图/image-20220112150820284.png)

- **UserDetailService** 用来修改默认认证的数据源信息

  ![image-20220112150929998](SpringSecurity截图/image-20220112150929998.png)
...
![image-20220113050533209](SpringSecurity截图/image-20220113050533209-2023951.png)
...
![image-20220113054514897](SpringSecurity截图/image-20220113054514897-2023963.png)
...
![image-20220113062644363](SpringSecurity截图/image-20220113062644363-2026405.png)
...
![image-20220113060257662](SpringSecurity截图/image-20220113060257662.png)
...
![image-20220113062114741](SpringSecurity截图/image-20220113062114741.png)
...
![image-20220113062617937](SpringSecurity截图/image-20220113062617937-2026380.png)
...
- 前后端分离注销登录配置
  ...
  ![image-20220113114133687](SpringSecurity截图/image-20220113114133687.png)
...
![image-20220113115956334](SpringSecurity截图/image-20220113115956334.png)
...
![image-20220113125407538](SpringSecurity截图/image-20220113125407538-2049649.png)
...
![image-20220113124141492](SpringSecurity截图/image-20220113124141492.png)
...
![image-20220113124639102](SpringSecurity截图/image-20220113124639102.png)
...
![image-20220118060526805](SpringSecurity截图/image-20220118060526805.png)
...
![image-20220118061756972](SpringSecurity截图/image-20220118061756972.png)
...
![image-20220118060824066](SpringSecurity截图/image-20220118060824066.png)
...
![image-20220118061343516](SpringSecurity截图/image-20220118061343516.png)
...
![image-20220114163045543](SpringSecurity截图/image-20220114163045543.png)
...
![image-20220127162622771](SpringSecurity截图/image-20220127162622771.png)

![image-20220127162759461](SpringSecurity截图/image-20220127162759461.png)
...
![image-20220308185102746](SpringSecurity截图/image-20220308185102746.png)
...
![image-20220308190409305](SpringSecurity截图/image-20220308190409305.png)
...
![image-20220317194843649](SpringSecurity截图/image-20220317194843649.png)

从上图中，当在SecurityConfig配置中开启了"记住我"功能之后,在进行认证时如果勾选了"记住我"选项，此时打开浏览器控制台，分析整个登录过程。首先当我们登录时，在登录请求中多了一个 RememberMe 的参数。

![image-20220308191736005](SpringSecurity截图/image-20220308191736005.png)
...
![image-20220317195930708](SpringSecurity截图/image-20220317195930708.png)
...
![image-20220317200522015](SpringSecurity截图/image-20220317200522015.png)

### TokenBasedRememberMeServices

在开启记住我后如果没有加入额外配置默认实现就是由TokenBasedRememberMeServices进行的实现。查看这个类源码中 processAutoLoginCookie 方法实现:

![image-20220317201055784](SpringSecurity截图/image-20220317201055784.png)
...
![image-20220318142054096](SpringSecurity截图/image-20220318142054096.png)
...
![image-20220308192413735](SpringSecurity截图/image-20220308192413735.png)

![image-20220319124115432](SpringSecurity截图/image-20220319124115432.png)

## 内存令牌

### PersistentTokenBasedRememberMeServices

![image-20220319104657210](SpringSecurity截图/image-20220319104657210.png)
...
![image-20220224142025628](SpringSecurity截图/image-20220224142025628.png)
...
![image-20200814184455083](SpringSecurity截图/image-20200814184455083.png)

![image-20200814184605516](SpringSecurity截图/image-20200814184605516.png)

![image-20200814184651238](SpringSecurity截图/image-20200814184651238.png)

![image-20200814185157418](SpringSecurity截图/image-20200814185157418.png)
...
完成登录操作；当第二个浏览器登录成功后，再回到第一个浏览器，刷新页面。结果出现下图：![image-20220308195448860](SpringSecurity截图/image-20220308195448860.png)
...
![image-20220418191456109](SpringSecurity截图/image-20220418191456109.png)
...
![image-20220418193519717](SpringSecurity截图/image-20220418193519717.png)
...
![image-20220418194059737](SpringSecurity截图/image-20220418194059737.png)
...
![image-20220521074711128](SpringSecurity截图/image-20220521074711128.png)
...
![image-20220430213210778](SpringSecurity截图/image-20220430213210778.png)

相比于认证异常，权限异常类就要少了很多，默认提供的权限异常如下：

![image-20220430213344621](SpringSecurity截图/image-20220430213344621.png)
...
![image-20220523110143445](SpringSecurity截图/image-20220523110143445.png)
...
![image-20220523153200373](SpringSecurity截图/image-20220523153200373.png)
...
![image-20220618140440796](SpringSecurity截图/image-20220618140440796.png)
...
![image-20220711201517843](SpringSecurity截图/image-20220711201517843.png)
...
![image-20220625085816021](SpringSecurity截图/image-20220625085816021.png)
...
![image-20220625090018332](SpringSecurity截图/image-20220625090018332.png)
...
![image-20220625090540320](SpringSecurity截图/image-20220625090540320.png)
...
![image-20220625090710221](SpringSecurity截图/image-20220625090710221.png)
...
![image-20220625090900509](SpringSecurity截图/image-20220625090900509.png)
...
![image-20220601100844019](SpringSecurity截图/image-20220601100844019.png)

- 创建 OAuth App并输入一下基本信息:

![image-20220601101157267](SpringSecurity截图/image-20220601101157267.png)

- 注册成功后会获取到对应的 Client ID 和 Client Secret。

![image-20220601101312113](SpringSecurity截图/image-20220601101312113.png)
...
![image-20220601102620149](SpringSecurity截图/image-20220601102620149.png)

- 点击 github 登录,点击授权 访问 hello 接口

![image-20220601102749454](SpringSecurity截图/image-20220601102749454.png)
...
![image-20220811212147719](SpringSecurity截图/image-20220811212147719.png)

```http
http://localhost:8080/oauth/authorize?client_id=client&response_type=code&redirect_uri=http://www.baidu.com
```

![image-20220811212242159](SpringSecurity截图/image-20220811212242159.png)

点击授权获取授权码

![image-20220811212334084](SpringSecurity截图/image-20220811212334084.png)
...
![image-20220811212426451](SpringSecurity截图/image-20220811212426451.png)
...
![image-20220811212512798](SpringSecurity截图/image-20220811212512798.png)
...
![image-20220811220339448](SpringSecurity截图/image-20220811220339448.png)
...
![image-20220812153300057](SpringSecurity截图/image-20220812153300057.png)
...
![image-20220812155121319](SpringSecurity截图/image-20220812155121319.png)
...
![image-20220812160042315](SpringSecurity截图/image-20220812160042315.png)
