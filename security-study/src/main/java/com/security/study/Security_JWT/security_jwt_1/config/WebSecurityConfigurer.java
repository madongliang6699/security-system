...
import com.security.study.Security_JWT.security_jwt_1.filter.LoginKaptchaFilter;
...
import static com.security.study.Security_JWT.security_jwt_1.filter.LoginKaptchaFilter.VERIFICATION_CODE;

/**
 * ⾃定义资源权限规则，请求拦截规则
 */
//@Configuration //todo 测试文件夹 security_jwt_2 中的代码，这里先注释掉
public class WebSecurityConfigurer extends WebSecurityConfigurerAdapter {
    ...
    private static final String[] AUTH_WHITELIST = {
            ...
            "/swagger-ui.html",
            "/v3/api-docs",
            "/v2/api-docs",//如果在swagger配置类中指定使用的是swagger2（SWAGGER_2），需要放行这个地址
            "/webjars/**"
    };
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .mvcMatchers("/swagger-ui/**").permitAll()//swagger接口放行
