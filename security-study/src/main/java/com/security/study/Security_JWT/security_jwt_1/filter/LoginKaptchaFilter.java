package com.security.study.Security_JWT.security_jwt_1.filter;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.security.study.Security_JWT.security_jwt_1.exception.KaptchaNotMatchException;
...
//            String password = request.getParameter(getPasswordParameter());
            ...
            if (!verificationCode.equalsIgnoreCase(sessionVerifyCode)) {
//                throw new KaptchaNotMatchException("验证码不匹配!");
            ...
            throw new KaptchaNotMatchException("登录异常: " + e.getMessage());
        }
    }
